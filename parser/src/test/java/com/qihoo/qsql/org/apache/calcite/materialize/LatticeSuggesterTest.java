 ...
 */
package com.qihoo.qsql.org.apache.calcite.materialize;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.Iterables;
import com.qihoo.qsql.org.apache.calcite.prepare.PlannerImpl;
...
import com.qihoo.qsql.org.apache.calcite.sql.fun.SqlLibrary;
import com.qihoo.qsql.org.apache.calcite.sql.fun.SqlLibraryOperatorTableFactory;
...
import com.qihoo.qsql.org.apache.calcite.test.CalciteAssert;
import com.qihoo.qsql.org.apache.calcite.test.FoodMartQuerySet;
import com.qihoo.qsql.org.apache.calcite.test.SlowTests;
...
import com.qihoo.qsql.org.apache.calcite.statistic.MapSqlStatisticProvider;
...
public class LatticeSuggesterTest {
     ...
     */
    @Test
    public void testExpressionEvolution() throws Exception {
        final Tester t = new Tester().foodmart().withEvolve(true);
    ...
    @Test
    public void testRedshiftDialect() throws Exception {
        final Tester t = new Tester().foodmart().withEvolve(true)
